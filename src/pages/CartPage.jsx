                ...
                <div key={product.id} className="">
                      ...
                      <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        <div>
                          ...
                          <div className="mt-1 flex items-end">
                            ...
                            <p className="text-sm ml-4 font-medium text-green-500">{product.discount}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mb-2 flex">
                    <div className="min-w-24 flex">
                      <button type="button" className="h-7 w-7 border rounded-md">
                        -
                      </button>
                      <input
                        type="text"
                        ...
                        defaultValue={1}
                      />
                      <button type="button" className="flex h-7 w-7 items-center border rounded-md justify-center">
                        +
                      </button>
                    </div>
